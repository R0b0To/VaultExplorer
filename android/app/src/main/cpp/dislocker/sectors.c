	...
	uint8_t* output)
{
	...
	ssize_t read_size = dis_pread(io_data->volume_fd, input, size, off);
	...
	uint8_t* output)
{
	...
	read_size = dis_pread(io_data->volume_fd, input, io_data->sector_size, to);
