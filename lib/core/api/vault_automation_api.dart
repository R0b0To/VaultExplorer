// Extracted from vault_explorer_api_automation.dart (old _AutomationOps mixin) as part of the Riverpod migration, Phase 2.
...
class VaultAutomationApi {
  final MethodChannel _channel;
  const VaultAutomationApi(this._channel);
  ...
  Future<String?> getAutomationToken() async {
    try {
      ...
      logSwallowed('getAutomationToken', e);
      return null;
    }
  }
  ...
  Future<String?> regenerateAutomationToken() async {
    try {
      ...
      logSwallowed('regenerateAutomationToken', e);
      return null;
    }
  }
  ...
  Future<AutomationVaultConfig> getAutomationVaultConfig(
    ...
    try {
      ...
      logSwallowed('getAutomationVaultConfig', e);
      return (
  ...
  Future<bool> setAutomationCaptureEnabled(
    ...
    try {
      ...
      logSwallowed('setAutomationCaptureEnabled', e);
      return false;
    }
  }
  ...
  Future<bool> setAutomationTier(
    ...
    try {
      ...
      logSwallowed('setAutomationTier', e);
      return false;
    }
  }
  ...
  Future<bool> setAutomationPassword(String vaultUri, String? password) async {
    try {
      ...
      logSwallowed('setAutomationPassword', e);
      return false;
    }
  }
  ...
  Future<List<String>?> getAutomationKeyfiles(String vaultUri) async {
    try {
      ...
      logSwallowed('getAutomationKeyfiles', e);
      return null;
    }
  }
  ...
  Future<bool> setAutomationKeyfiles(
    ...
    try {
      ...
      logSwallowed('setAutomationKeyfiles', e);
      return false;
    }
  }
  ...
  Future<int?> getAutomationPim(String vaultUri) async {
    try {
      ...
      logSwallowed('getAutomationPim', e);
      return null;
    }
  }
  ...
  Future<bool> setAutomationPim(String vaultUri, int? pim) async {
    try {
      ...
      logSwallowed('setAutomationPim', e);
      return false;
    }
  }
  ...
  Future<List<MountedContainer>> getActiveContainerSessions() async {
    try {
      ...
      logSwallowed('getActiveContainerSessions', e);
      return const [];
    }
  }
}