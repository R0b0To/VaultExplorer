// Extracted from vault_explorer_api_hash.dart (old mixin) as part of the Riverpod migration, Phase 2.
...
class VaultHashApi {
  ...
  const VaultHashApi(this._channel);
  ...
  Future<void> discardHashSession(int opId) async {
    try {
      ...
      logSwallowed('discardHashSession', e, expected: true);
    }
  }
  ...
  Future<void> cancelHashCompute(int opId) async {
    try {
      ...
      logSwallowed('cancelHashCompute', e, expected: true);
    }
  }
