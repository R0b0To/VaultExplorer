...
Future<String> _resolveAndroidVersion() async {
  try {
    final sdkInt = await vaultExplorerApi.getAndroidSdkInt();
...
class _ReportIssueSheet extends StatelessWidget {
  ...
  Future<void> _openBugReport(BuildContext context) async {
    final androidVersion = await _resolveAndroidVersion();
  ...
  Future<void> _openContainerIssue(BuildContext context) async {
    final androidVersion = await _resolveAndroidVersion();
    final url = _buildIssueUrl(
  ...
  Future<void> _openChooser(BuildContext context) async {
    await _open(context, _kIssuesChooseUrl);
  }
      ...
      child: Column(
        ...
        children: [
          ...
          SheetOptionTile(
            ...
            onTap: () => _openContainerIssue(context),
          ),
          SheetOptionTile(
